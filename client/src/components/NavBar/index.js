...
class NavbarPage extends Component {
  ...
  render() {
    const userAction = this.props.user === "loading" ? null : this.props.user ? <IsLogged user={this.props.user}/> : <UnLogged />
    return (
      <Router>
      <MDBNavbar color="elegant-color-dark" dark expand="md">
        <MDBContainer>
        <MDBNavbarBrand>
            <strong className="white-text">Django-React Boards</strong>
          </MDBNavbarBrand>
            <MDBNavbarNav right>
              <MDBNavItem>
                { userAction }
    ...
    export default isAuth(NavbarPage);
